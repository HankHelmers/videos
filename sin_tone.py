# Source - https://stackoverflow.com/a/974291
...
from pyaudio import PyAudio # conda installed 
...
sine_tone(
    ...
    frequency=100.00, # Hz, waves per second A4
...
sine_tone(
    # see http://www.phy.mtu.edu/~suits/notefreqs.html
    frequency=150.00, # Hz, waves per second A4
    duration=3.21, # seconds to play sound
    volume=.01, # 0..1 how loud it is
    # see http://en.wikipedia.org/wiki/Bit_rate#Audio
    sample_rate=22050 # number of samples per second
